...
"""
# File       : testuiaotomation.py
# Time       ：2023/8/14 16:23
# Author     ：wwa
# version    ：python 3.11
# Description：
"""
...
def wechat():
    auto.GetRootControl()
    wechatWin = auto.WindowControl(searchDepth=1,ClassName='WeChatMainWndForPC',Name='微信')
    # chatBody = wechatWin.ButtonControl(Name='半瓶醋')
    # chatBody.Click()
    messages = wechatWin.ListControl(Name='消息')
