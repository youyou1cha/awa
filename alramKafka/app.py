...
from slogging import setup_logging
# read config
cfg = toml.load("config.toml")
logger = setup_logging("log_file.log")
# logging.basicConfig(
#     level=logging.DEBUG,
...
heartbeat_topic = cfg['kafka'][
    'heartbeat_topic']  # Kafka topic to send heartbeat data
heartbeat_interval = cfg['kafka'][
